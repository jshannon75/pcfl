---
title: "**PCFL 2025: Week 4 wrap-up**"
output:
  html_document:
    toc: true
    toc_float: 
...
Pigskin on the Gridiron (Richard) had a stellar week! 
...
Recipe for a struggling young running back: play the Bears' defense. See: Jeanty, Ashton. Brian and I both also had our best players on the bench.
...
**NEW THIS WEEK** I've tallied the players picked up by each team and the points they've contributed as starters. Here's where those stand.
...
Sasquatch as always has the lead here.
...
The Broncos (Will) are perfect thus far.

### If the season ended today...

Our playoff teams would be the Broncos, Henry's, Sharks, and the Jaheims's. 
...
Let's see if the defending champions (Sasquatch) can flex their muscles against our new 1st place team.
